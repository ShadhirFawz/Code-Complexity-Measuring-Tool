...
const HalsteadMetricCalculator: FC = () => {
    ...
    const handleGeneratePdf = (): void => {
        ...
        doc.text("Code hastead matrix", 105, y, {
            align: "center",
        })
        ...
        if (complexity) {
            doc.text(
                `Vocabulary: ${complexity.vocabulary.toFixed(2)}`,
                10,
                y + 10,
            )
        }
        ...
        doc.setFontSize(14)
        if (complexity) {
            doc.text(`Length: ${complexity.length.toFixed(2)}`, 10, y + 10)
        }

        y += 10
        doc.setFontSize(14)
        if (complexity) {
            doc.text(`Effort: ${complexity.effort.toFixed(2)}`, 10, y + 10)
        }
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-gray-800">
            <div className="w-full max-w-2xl rounded-lg bg-gray-900 p-6 shadow-md">
                ...
                {complexity !== null && (
                    <div>
                        <p>Calculated Complexity:</p>

                        <ul>
                            <li>
                                Vocabulary:{" "}
                                {complexity.vocabulary
                                    ? complexity.vocabulary.toFixed(2)
                                    : "N/A"}
                            </li>
                            <li>
                                Length:{" "}
                                {complexity.length
                                    ? complexity.length.toFixed(2)
                                    : "N/A"}
                            </li>
                            <li>
                                Volume:{" "}
                ...
                <div className="m-4 rounded-lg border border-gray-200 bg-gray-800 p-6 shadow-lg">
                    ...
                    <ul className="list-disc pl-5">
                        <li className="text-lg text-indigo-500">
                            <strong>Length (N):</strong> This is the total
                            number of operators and operands in the code.
                        </li>
                        <li className="text-lg text-indigo-500">
                            <strong>Vocabulary:</strong> The number of unique
                            operators and operands.
                        </li>
                        <li className="text-lg text-indigo-500">
                            <strong>Volume:</strong> Represents the size of the
                            code.
                        </li>
                        <li className="text-lg text-indigo-500">
                            <strong>Difficulty:</strong> Measures how difficult
                            the code is to understand.
                        </li>
                        <li className="text-lg text-indigo-500">
                            <strong>Effort:</strong> The effort required to
